...
protected:
    ...
    glm::mat4 inverseTransf = glm::mat4(1.0f);
    glm::mat4 normalTransf = glm::mat4(1.0f);
...
public:
	...
	glm::vec3 lighting(const glm::vec3& lightPos, const glm::vec3& viewVec, const glm::vec3& hit);
